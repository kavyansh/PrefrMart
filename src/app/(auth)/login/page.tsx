...
export default async function LoginPage({
  ...
  /*
   * NextAuth sends failed OAuth attempts back here, because `pages.error` points at this
   * route. The common one is OAuthAccountNotLinked: the provider's email already belongs to
   * a password account, which we refuse to link automatically.
   */
  ...
  return (
    <main id="main" className="mx-auto max-w-sm px-4 py-10">
      ...
      <AuthForm mode="login" next={target} initialError={oauthError} />
